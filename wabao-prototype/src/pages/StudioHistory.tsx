      ...
      <div className="mx-auto max-w-4xl px-6 py-8">
        ...
        {creations.length === 0 ? (
          <div className="mt-20 text-center text-slate-400">
            还没有创作记录，去
            <button className="mx-1 text-brand-600 hover:underline" onClick={() => navigate("/app/studio")}>
              创作工作室
            </button>
            生成第一篇内容吧 ✨
          </div>
